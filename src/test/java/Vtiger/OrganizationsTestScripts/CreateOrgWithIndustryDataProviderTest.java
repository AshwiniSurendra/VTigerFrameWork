...
public class CreateOrgWithIndustryDataProviderTest extends BaseClass {
@Test(dataProvider="Orgnization")
public void createOrgWithIndustryDataProviderTest(String OrgName,String Industry) throws IOException
{
